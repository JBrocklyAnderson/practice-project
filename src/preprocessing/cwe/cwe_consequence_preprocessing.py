"""
This script will clean the CWE consequence data pulled out of the project's main
...
COL_TYPES = {
    'string': ['cwe_id', 'cwe_consequence_desc', 'cwe_miti_effect_notes'],
    'category': ['cwe_miti_phase', 'source_table']
}

def run_cwe_consequence_preprocessing(
        input_file: str,
        output_file: str,
